...
for i in 1 2 3; do
    docker run -it -d --rm --name rabbit$i -h rabbit$i --net=rabbit-test -v $PWD/enabled_plugins:/etc/rabbitmq/enabled_plugins -v $PWD/erlang-cookie.key:/var/lib/rabbitmq/.erlang.cookie -p 567$i:5672 --ulimit nofile=65536:65536 rabbitmq:$VERSION
done
